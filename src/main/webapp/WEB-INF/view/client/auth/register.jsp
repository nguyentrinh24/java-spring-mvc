                                    ...
                                    <div class="col-lg-7">
                                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                                            ...
                                            <div class="card-body">
                                                ...
                                                <form action="/register" method="POST" modelAttribute="registerUser">
                                                    <div class="row mb-3">
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-md-6">
                                                            <label for="inputPasswordConfirm" class="form-label">Confirm
                                                                Password</label>
                                                            <div class="form-floating mb-3 mb-md-0">
                                                    ...
                                                    <div class="mt-4 mb-0">
                                                        <!-- Changed to a submit button for form submission -->
